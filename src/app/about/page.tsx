...
const page = () => {
  ...
  <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
    ...
    <div className="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
      <h1 className="title-font sm:text-4xl text-3xl mb-4 font-medium text-blue-900">I am Muhammad Sameer
        <br className="hidden lg:inline-block"/>
      </h1>
      <p className="mb-8 leading-relaxed">I am deeply interested in finance, specially in Accounting, Economics, Business Studies along with Aritifical intelligence and block chain technology. Always want to try some unique combination to add value in fintech and make combination of research specially in MS and PHD side alone with computer integration. Because one should be flexible.</p>
